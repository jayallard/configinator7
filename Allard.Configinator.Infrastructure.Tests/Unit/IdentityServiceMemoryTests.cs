...
public class IdentityServiceMemoryTests
{
    ...
    public async Task ShouldWork()
    {
        ...
        (await service.GetId<SectionSchemaId>()).Id.Should().Be(0);
        (await service.GetId<SectionSchemaId>()).Id.Should().Be(1);
        (await service.GetId<SectionSchemaId>()).Id.Should().Be(2);
        (await service.GetId<SectionSchemaId>()).Id.Should().Be(3);
    }
}
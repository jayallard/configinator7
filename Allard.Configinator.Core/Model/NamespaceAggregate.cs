...
public class NamespaceAggregate : AggregateBase<NamespaceId>
{
    ...
    internal void AddVariableSet(VariableSetId variableSetId) => Play(new VariableSetAddedToNamespaceEvent(Id, variableSetId));
    internal void AddSection(SectionId sectionId) => Play(new SectionAddedToNamespaceEvent(Id, sectionId));

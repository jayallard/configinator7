        ...
        var list = (await _repository.FindAsync(new All(), cancellationToken))
            .Select(async t =>
            {
                ...
                if (t.BaseVariableSetName != null)
                    return new VariableSetListItemDto(t.Namespace, t.VariableSetName, t.EnvironmentType, t.BaseVariableSetName,
                        null);
                var composed =
                ...
                return new VariableSetListItemDto( t.Namespace, t.VariableSetName, t.EnvironmentType, t.BaseVariableSetName, mermaid);
            }).ToList();
